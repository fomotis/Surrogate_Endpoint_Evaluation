...
\begin{tabular}{rrrrrrrr}
  \hline
S & $\rho_{UN}$ & $\rho_{S,T|Z}$ & LCI & UCI & $S_{Trt}$ & pval & pvaladj \\ 
  \hline
...
\tiny
\begin{itemize}
\item addition of surrogate 22 improved ICA value for surrogate 18, but the range of the bivariate surrogates 18 and 22 is more than the other top bivariate surrogates
