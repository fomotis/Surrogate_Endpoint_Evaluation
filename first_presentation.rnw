...
The chief aim of this thesis is to validate elements of the human microbiome, specifically the gut microbiome as potential surrogates for insulin sensitivity in patients with metabolic disorder. Individual elements of the gut microbiome are going to be validated as surrogates and also a combination of these elements will also be validated as potential surrogates. This is essential since the full function of the human microbiome is unknown, hence being able to assertain that some elements of the microbiome can serve as potential surrogates 
